...
public class RegisterCustomer {
    ...
    private static JLabel lblFname, lblLname, lblPhone, lblAddress, lblGender, lblUsername, lblPassword,
            lblConfirmPassword;
    ...
    private void registerCustomer() {
        ...
        if (password.equals(confirmPassword)) {
            ...
            int insert = customerController.registerCustomerPrepaedStatement(customer);
